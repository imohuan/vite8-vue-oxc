  ...
  planOperations(input, adapter) {
    ...
    return entries.flatMap(({ module, sourceRelativePath }) => {
      ...
      if (sourceRelativePath === "mcp-configs") {
        const operations = [adapter.createScaffoldOperation(module.id, sourceRelativePath, planningInput)];
      ...
      return takeUniqueOperations([adapter.createScaffoldOperation(module.id, sourceRelativePath, planningInput)]);
    });
  },
});
